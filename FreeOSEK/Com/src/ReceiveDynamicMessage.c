...
/** \brief FreeOSEK Com ReceiveDynamicMessage Implementation File
 **
 ** This file implements the ReceiveDynamicMessage API
 **
 ** \file ReceiveDynamicMessage.c
 **
 **/
...
StatusType ReceiveDynamicMessage
(
