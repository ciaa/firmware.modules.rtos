...
/** \brief FreeOSEK Com SendDynamicMessage Implementation File
 **
 ** This file implements the SendDynamicMessage API
 **
 ** \file SendDynamicMessage.c
 **
 **/
