...
/** \brief FreeOSEK Driver StartUp assembler file for arm7/lpc2xxx
 **
 ** \file arm7/lpc2xxx/StartUp.s
 ** \arch arm7/lpc2xxx
 **/
 ...
 * -----------------------------------------------------------
 * 20111015 v0.1.1 KT	merged Startup.s and StartUp_Asm.s,
 * 							updated the interrupt vector table
 * 20081126 v0.1.0 MaCe	initial version based on software without author.
 */
...
_vectors:
			...
			ldr PC, [PC,#-0xFF0]	/* IRQ Vector, see page 71 of "Insiders Guide to
											the Philips ARM7-Based Microcontrollers"
											by Trevor Martin */
...
IRQ_Addr:    .word  DefaultIrqHandler_Arch	/* defined in Osek_Internal_Arch.c */
FIQ_Addr:    .word  TimerIrqHandler_Arch		/* defined in Osek_Internal_Arch.c */
