...
/** \brief FreeOSEK Driver ADC Start Group Conversion implementation file
 **
 ** This file implements the Adc_StartGroupConversion API
 **
 ** \file Adc_StartGroupConversion.c
 **
 **/
