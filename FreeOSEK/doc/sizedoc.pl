...
sub wf_start
{
	...
	print OUT " *\n";
	print OUT " * This file is part of FreeOSEK.\n";
	print OUT " *\n";
	print OUT " * FreeOSEK is free software: you can redistribute it and/or modify\n";
	...
	print OUT " * Linking FreeOSEK statically or dynamically with other modules is making a\n";
	print OUT " * combined work based on FreeOSEK. Thus, the terms and conditions of the GNU\n";
	...
	print OUT " *\n";
	print OUT " * Note that people who make modified versions of FreeOSEK are not obligated to\n";
	...
	print OUT " *\n";
	print OUT " * FreeOSEK is distributed in the hope that it will be useful,\n";
	...
	print OUT " * along with FreeOSEK. If not, see <http://www.gnu.org/licenses/>.\n";
	print OUT " *\n";
	print OUT " */\n\n";
	print OUT "/** \\page FreeOSEK_Size Project ROM/RAM Memory Consumption\n";
	wf();
}
...
print "FreeOSEK Size Tool - Copyright 2008, Mariano Cerdeiro - http://www.openosek.com.ar\n\n";
info("------ LICENSE START ------");
...
{
	wf(" - \\ref FreeOSEK_Size_$mod");
	wf("  - \\ref FreeOSEK_Size_$mod" . "_Summary");
}
wf(" - \\ref FreeOSEK_Size_Total");
wf();
...
foreach my $mod (@modules)
{
	...
	wf("\\section FreeOSEK_Size_$mod Size Section $mod");
	wf();
	...
	wf();
	wf("\\subsection FreeOSEK_Size_$mod" . "_Summary Summary for this module");
	wf();
...
wf("\\section FreeOSEK_Size_Total Total RAM/ROM Consumption");
wf();
